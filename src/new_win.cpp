...
void NewWin::Draw() {
    ...
    if (this->open) {
        this->open =
            !GuiWindowBox((Rectangle){this->offset.x, this->offset.y, 200, 465},
                          "New Project");
        ...
        if (GuiValueBox(
                ...
                "Height", &this->height, 1, 10000, this->heightEditMode)) {
            this->heightEditMode = !this->heightEditMode;
        }
        //----------------------------------------------------------------------
        // Name Input
        GuiLabel((Rectangle){this->offset.x + 10, this->offset.y + 170, 33, 25},
                 "Name");
        if (GuiTextBox(
                (Rectangle){this->offset.x + 10, this->offset.y + 190, 180, 25},
